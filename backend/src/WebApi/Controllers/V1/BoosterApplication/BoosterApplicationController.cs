...
using Application.BoosterApplications.Queries.GetBoosterApplicationDetails;
...
{
    [HttpGet]
    public async Task<Ok<PaginatedList<BoosterApplicationDto>>> GetBoosterApplications(
        [FromQuery] BoosterApplicationFilter filter)
    {
